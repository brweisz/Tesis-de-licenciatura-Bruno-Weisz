...
Supongamos que tenemos un valor $k$ y queremos obtener su descomposición en $n$ bits ($k_0, k_1, \cdots, k_{n-1}$). La verificación de esta cuenta puede hacerse con una única ecuación de la forma 

$$k_0 \cdot 2^0 + k_1 + 2^1 + \cdots + k_{n-1}*2^{n-1} = k$$
